...
<h1 align="center">👋 Привет, меня зовут Аброр !</h1>
...
<div align="center">
  ...
  <a href="https://www.linkedin.com/in/avazjon-anvarov" target="_blank">
...
<div align="center">
  <img src="https://visitor-badge.laobi.icu/badge?page_id=avazjon7.avazjon7&"  />
</div>
...
<p align="left">
Я Django-разработчик и фрилансер. Занимаюсь backend-разработкой и создаю надёжные API для современных веб-проектов.  
Сейчас работаю над <b>Examinator App</b>, <b>Driver Prepare App</b> и <b>QR Link</b> — платформами для тестирования, автошкол и генерации QR-ссылок.  
